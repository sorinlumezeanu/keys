...
class TypeRowDescriptor: RowDescriptor {
    ...
    private struct Constants {
        static let CellIdentifier = "addSecretTypeCell"
    }
    ...
    var rowHeight: CGFloat {
        return TypeRowDescriptor.StandardRowHeight
    }
    ...
    func prepareCell(forTableView tableView: UITableView, indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = self.recordDescriptor.secret.type.rawValue
